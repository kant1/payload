...
function buildObjectType({ payload, name, fields, parentName, baseFields = {}, forceNullable, }) {
    const fieldToSchemaMap = {
        number: (objectTypeConfig, field) => {
            const type = (field === null || field === void 0 ? void 0 : field.name) === 'id' ? graphql_1.GraphQLInt : graphql_1.GraphQLFloat;
            return ({
                ...objectTypeConfig,
                [field.name]: { type: (0, withNullableType_1.default)(field, (field === null || field === void 0 ? void 0 : field.hasMany) === true ? new graphql_1.GraphQLList(type) : type, forceNullable) },
            });
        },
