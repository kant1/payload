...
const Button = (0, react_1.forwardRef)((props, ref) => {
    const { className, id, type = 'button', el = 'button', to, url, children, onClick, disabled, icon, iconStyle = 'without-border', buttonStyle = 'primary', round, size = 'medium', iconPosition = 'right', newTab, tooltip, 'aria-label': ariaLabel, } = props;
    ...
    switch (el) {
        ...
        case 'anchor':
            return (react_1.default.createElement("a", { ...buttonProps, ref: ref, href: url },
                react_1.default.createElement(ButtonContents, { icon: icon, tooltip: tooltip, showTooltip: showTooltip }, children)));
        default:
            const Tag = el; // eslint-disable-line no-case-declarations
            return (react_1.default.createElement(Tag, { type: "submit", ref: ref, ...buttonProps },
                react_1.default.createElement(ButtonContents, { icon: icon, tooltip: tooltip, showTooltip: showTooltip }, children)));
    }
});
