...
const ListControls = (props) => {
    ...
    return (react_1.default.createElement("div", { className: baseClass },
        react_1.default.createElement("div", { className: `${baseClass}__wrap` },
            ...
            react_1.default.createElement("div", { className: `${baseClass}__buttons` },
                react_1.default.createElement("div", { className: `${baseClass}__buttons-wrap` },
                    ...
                    enableColumns && (react_1.default.createElement(Pill_1.default, { pillStyle: "light", className: `${baseClass}__toggle-columns ${visibleDrawer === 'columns' ? `${baseClass}__buttons-active` : ''}`, onClick: () => setVisibleDrawer(visibleDrawer !== 'columns' ? 'columns' : undefined), "aria-expanded": visibleDrawer === 'columns', "aria-controls": `${baseClass}-columns`, icon: react_1.default.createElement(Chevron_1.default, null) }, t('columns'))),
                    react_1.default.createElement(Pill_1.default, { pillStyle: "light", className: `${baseClass}__toggle-where ${visibleDrawer === 'where' ? `${baseClass}__buttons-active` : ''}`, onClick: () => setVisibleDrawer(visibleDrawer !== 'where' ? 'where' : undefined), "aria-expanded": visibleDrawer === 'where', "aria-controls": `${baseClass}-where`, icon: react_1.default.createElement(Chevron_1.default, null) }, t('filters')),
                    enableSort && (react_1.default.createElement(Button_1.default, { className: `${baseClass}__toggle-sort`, buttonStyle: visibleDrawer === 'sort' ? undefined : 'secondary', onClick: () => setVisibleDrawer(visibleDrawer !== 'sort' ? 'sort' : undefined), "aria-expanded": visibleDrawer === 'sort', "aria-controls": `${baseClass}-sort`, icon: "chevron", iconStyle: "none" }, t('sort')))))),
        enableColumns && (react_1.default.createElement(react_animate_height_1.default, { className: `${baseClass}__columns`, height: visibleDrawer === 'columns' ? 'auto' : 0, id: `${baseClass}-columns` },
            react_1.default.createElement(ColumnSelector_1.default, { collection: collection }))),
        react_1.default.createElement(react_animate_height_1.default, { className: `${baseClass}__where`, height: visibleDrawer === 'where' ? 'auto' : 0, id: `${baseClass}-where` },
        ...
        enableSort && (react_1.default.createElement(react_animate_height_1.default, { className: `${baseClass}__sort`, height: visibleDrawer === 'sort' ? 'auto' : 0, id: `${baseClass}-sort` },
