...
const FileDetails = (props) => {
    ...
    const { upload: { staticURL, imageSizes, }, slug: collectionSlug, } = collection;
    const { filename, filesize, width, height, mimeType, sizes, url, id, } = doc;
    ...
    return (react_1.default.createElement("div", { className: baseClass },
        react_1.default.createElement("header", null,
            ...
            react_1.default.createElement("div", { className: `${baseClass}__main-detail` },
                react_1.default.createElement(Meta_1.default, { staticURL: staticURL, filename: filename, filesize: filesize, width: width, height: height, mimeType: mimeType, url: url, id: id, collection: collectionSlug }),
