    ...
    return (react_1.default.createElement("aside", { className: classes },
        react_1.default.createElement("div", { className: `${baseClass}__scroll` },
            react_1.default.createElement("header", null,
                react_1.default.createElement(react_router_dom_1.Link, { to: admin, className: `${baseClass}__brand`, "aria-label": t('dashboard') },
            ...
            react_1.default.createElement("nav", { className: `${baseClass}__wrap` },
                ...
                react_1.default.createElement("div", { className: `${baseClass}__controls` },
                    ...
                    react_1.default.createElement(react_router_dom_1.Link, { to: `${admin}/account`, className: `${baseClass}__account`, "aria-label": t('authentication:account') },
