...
const StaticPill = (props) => {
    const { className, to, icon, alignIcon = 'right', onClick, pillStyle = 'light', draggable, children, elementProps, rounded, 'aria-label': ariaLabel, 'aria-expanded': ariaExpanded, 'aria-controls': ariaControls, 'aria-checked': ariaChecked, } = props;
    const classes = [
        baseClass,
    ...
    return (react_1.default.createElement(Element, { ...elementProps, "aria-label": ariaLabel, "aria-expanded": ariaExpanded, "aria-controls": ariaControls, "aria-checked": ariaChecked, className: classes, type: Element === 'button' ? 'button' : undefined, to: to || undefined, onClick: onClick },
