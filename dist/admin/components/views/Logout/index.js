...
const Logout = (props) => {
    ...
    return (react_1.default.createElement(Minimal_1.default, { className: baseClass },
        ...
        react_1.default.createElement("div", { className: `${baseClass}__wrap` },
            ...
            react_1.default.createElement(Button_1.default, { el: "anchor", buttonStyle: "secondary", url: `${admin}/login${redirect && redirect.length > 0 ? `?redirect=${encodeURIComponent(redirect)}` : ''}` }, t('logBackIn')))));
};
