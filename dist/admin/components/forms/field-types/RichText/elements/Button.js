...
const ElementButton = (props) => {
    const { format, children, onClick, className, tooltip, type = 'type', el = 'button', } = props;
    const editor = (0, slate_react_1.useSlate)();
    const [showTooltip, setShowTooltip] = (0, react_1.useState)(false);
    const defaultOnClick = (0, react_1.useCallback)((event) => {
        event.preventDefault();
        setShowTooltip(false);
        (0, toggle_1.default)(editor, format, type);
    }, [editor, format, type]);
    const Tag = el;
    return (react_1.default.createElement(Tag, { ...el === 'button' && { type: 'button' }, className: [
            exports.baseClass,
            className,
            (0, isActive_1.default)(editor, format, type) && `${exports.baseClass}__button--active`,
