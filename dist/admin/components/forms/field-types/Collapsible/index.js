...
const CollapsibleField = (props) => {
    ...
    return (react_1.default.createElement("div", { id: `field-${fieldPreferencesKey}${path ? `-${path.replace(/\./gi, '__')}` : ''}` },
        ...
        react_1.default.createElement(Collapsible_1.Collapsible, { initCollapsed: collapsedOnMount, className: classes, collapsibleStyle: errorCount > 0 ? 'error' : 'default', header: (react_1.default.createElement("div", { className: `${baseClass}__row-label-wrap` },
                react_1.default.createElement(RowLabel_1.RowLabel, { path: path, label: label }),
                errorCount > 0 && (react_1.default.createElement(ErrorPill_1.ErrorPill, { count: errorCount, withMessage: true })))), onToggle: onToggle },
