...
const MultiValueLabel = (props) => {
    var _a, _b, _c;
    const { data: { value, relationTo, label, }, selectProps: { customProps: { setDrawerIsOpen, draggableProps,
    // onSave,
     } = {}, } = {}, } = props;
    ...
    return (react_1.default.createElement("div", { className: baseClass },
        ...
        relationTo && hasReadPermission && (react_1.default.createElement(react_1.Fragment, null,
            ...
            react_1.default.createElement(DocumentDrawer, { onSave: /* onSave */ null })))));
};
