...
const RichText = (props) => {
    ...
    const renderElement = (0, react_1.useCallback)(({ attributes, children, element }) => {
        ...
        if (Element) {
            const el = (react_1.default.createElement(Element, { attributes: attr, element: element, path: path, fieldProps: props, editorRef: editorRef }, children));
            return el;
        }
        return (react_1.default.createElement("div", { ...attr }, children));
