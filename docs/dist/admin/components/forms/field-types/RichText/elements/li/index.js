...
const LI = (props) => {
    ...
    return (react_1.default.createElement("li", { style: { listStyle: disableListStyle ? 'none' : undefined, listStylePosition: disableListStyle ? 'outside' : undefined }, ...attributes }, children));
};
exports.default = {
    Element: LI,
};
