...
const Login = () => {
    ...
    react_1.default.createElement(Minimal_1.default, { className: baseClass },
        ...
        !collection.auth.disableLocalStrategy && (react_1.default.createElement(Form_1.default, { disableSuccessStatus: true, waitForAutocomplete: true, onSuccess: onSuccess, method: "post", action: `${serverURL}${api}/${userSlug}/login`, initialData: {
